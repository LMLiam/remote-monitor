...
type sample struct {
	...
	PowerSupplies         []core.PowerSupplyStat `json:"power_supplies"`
...
func fromCoreSample(smp core.Sample) sample {
	return sample{
		...
		PowerSupplies:         nonNilSlice(smp.PowerSupplies),
		ExternalPowerOnline:   smp.ExternalPowerOnline,
		BatteryPercent:        smp.BatteryPercent,
		BatteryStatus:         smp.BatteryStatus,
		PowerDrawWatts:        smp.PowerDrawWatts,
		UPSPresent:            smp.UPSPresent,
		PowerSourceName:       smp.PowerSourceName,
